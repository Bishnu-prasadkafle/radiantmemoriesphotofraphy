      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <h2
            ...
            <a href="booking.php">
        <i class="fa fa-camera-o" aria-hidden="true">Bookings</i> </a>
          </h2>
        <!-- now row start -->
          <div class="row">
              ...
              while($row=mysqli_fetch_array($run))
            {
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo $e;?></td>
                  <td><?php echo $f;?></td>
                  <td><a href="edit-booking.php?id=<?php echo $a;?> &Name= <?php echo $b;?>&address=<?php echo $c;?> &phone=<?php echo $d;?> &email=<?php echo $e;?> &photographers=<?php echo $f;?>"> Edit</a></td>   
